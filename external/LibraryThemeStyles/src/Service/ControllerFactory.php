...
{
    /**
     * Create an AdminController instance configured with the module configuration service.
     *
     * @return AdminController The constructed AdminController instance configured with the module configuration service.
     */
